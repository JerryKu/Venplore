        ...
        <div className="projects-section">
          ...
          <div className="project-items">
            ...
            <div className='project'>
              ...
              <p>The Front-End microsorvice for a YouTube emulator that received all requests from the client, routed them to the proper microservice, and returned search results.</p>
